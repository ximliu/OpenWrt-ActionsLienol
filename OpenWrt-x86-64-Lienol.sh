...
rm -rf ./package/lean/luci-theme-argon && git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git package/openwrt-packages/luci-theme-argon
...
CONFIG_KERNEL_BUILD_USER="Ezio"
CONFIG_GRUB_TITLE="OpenWrt AutoBuild by Ezio"
EOF
